...
def get_CIFAR10_data(num_training=49000, num_validation=1000, num_test=10000, num_dev=500):
    ...
    X_train, y_train, X_val, y_val, X_dev, y_dev, X_test, y_test = subsample(
        num_training, num_validation, num_test, num_dev, X_train, y_train, X_test, y_test)
...
def subsample(num_training, num_validation, num_test, num_dev, X_train, y_train, X_test, y_test):
    ...
    print('Dev data shape: %d,%d,%d,%d' % X_dev.shape)
    print('Test labels shape: %d' % y_dev.shape)
...
def preprocess(X_train, X_val, X_dev, X_test):
    ...
    print('dev data shape: %d,%d' % X_dev.shape)
    ...
    print('Devset data shape with bias term: %d,%d' % X_dev.shape)
