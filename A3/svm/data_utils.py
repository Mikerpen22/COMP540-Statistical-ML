...
def preprocess(X_train,X_val,X_dev,X_test):
  ...
  print('Validation data shape: %s' % X_val.shape)
  print('Test data shape: %s' % X_test.shape)
  print('dev data shape: %s' % X_dev.shape)
  ...
  print('Training data shape with bias term: %s ' % X_train.shape)
  print('Validation data shape with bias term: %s' % X_val.shape)
  print('Test data shape with bias term: %s' % X_test.shape)
  print('Devset data shape with bias term: %s' % X_dev.shape)
